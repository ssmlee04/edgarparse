...
export const CONCEPT_MAP: Record<string, ConceptEntry> = {
    ...
    // ── Income Statement — IFRS (ifrs-full namespace, used by 20-F / 6-K filers) ──
    'ifrs-full:Revenue': { label: 'revenue', statement: 'income' },
    'ifrs-full:RevenueFromContractsWithCustomers': { label: 'revenue', statement: 'income' },
    'ifrs-full:SalesAndServiceRevenue': { label: 'revenue', statement: 'income' },
    'ifrs-full:CostOfSales': { label: 'cost of revenue', statement: 'income' },
    'ifrs-full:GrossProfit': { label: 'gross profit', statement: 'income' },
    'ifrs-full:ResearchAndDevelopmentExpense': { label: 'research and development', statement: 'income' },
    'ifrs-full:AdministrativeExpense': { label: 'general and administrative', statement: 'income' },
    'ifrs-full:SellingExpense': { label: 'sales and marketing', statement: 'income' },
    'ifrs-full:DistributionCosts': { label: 'distribution costs', statement: 'income' },
    'ifrs-full:OtherExpenseByFunction': { label: 'other operating expense', statement: 'income' },
    'ifrs-full:OtherOperatingIncome': { label: 'other operating income', statement: 'income' },
    'ifrs-full:OtherOperatingIncomeExpense': { label: 'other operating income (expense)', statement: 'income' },
    'ifrs-full:ProfitLossFromOperatingActivities': { label: 'operating income', statement: 'income' },
    'ifrs-full:FinanceCosts': { label: 'interest expense', statement: 'income' },
    'ifrs-full:FinanceIncome': { label: 'interest income', statement: 'income' },
    'ifrs-full:ShareOfProfitLossOfAssociatesAndJointVenturesAccountedForUsingEquityMethod': { label: 'equity method investment income', statement: 'income' },
    'ifrs-full:ProfitLossBeforeTax': { label: 'income before income taxes', statement: 'income' },
    'ifrs-full:IncomeTaxExpenseContinuingOperations': { label: 'income tax expense (benefit)', statement: 'income' },
    'ifrs-full:ProfitLoss': { label: 'net income including noncontrolling interests', statement: 'income' },
    'ifrs-full:ProfitLossAttributableToOwnersOfParent': { label: 'net income', statement: 'income' },
    'ifrs-full:ProfitLossAttributableToNoncontrollingInterests': { label: 'net income attributable to noncontrolling interests', statement: 'income' },
    'ifrs-full:BasicEarningsLossPerShare': { label: 'earnings per share - basic', statement: 'income' },
    'ifrs-full:DilutedEarningsLossPerShare': { label: 'earnings per share - diluted', statement: 'income' },
    'ifrs-full:WeightedAverageNumberOfOrdinarySharesOutstanding': { label: 'weighted-average shares - basic', statement: 'income' },
    'ifrs-full:AdjustedWeightedAverageShares': { label: 'weighted-average shares - diluted', statement: 'income' },
